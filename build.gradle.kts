...
mavenPublishing {
    // Real API docs generated by Dokka instead of the default empty javadoc jar — publishes to
    // javadoc.io automatically once released (https://javadoc.io/doc/io.github.arkhes-dev/kaiorc).
